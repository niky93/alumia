...
@section('contenido')
            ...
            <div class="panel-body">
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="idarticulo" class="form-control selectpicker " id="pidarticulo" data-live-search="true" >
                ...
                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                        <thead style="background-color:#0089db " >
                        <th>Opciones</th>
                        <th>Articulo</th>
                        <th>Cantidad</th>
                        <th>Precio Compra</th>
    ...
    <div class="col-lg-6 col-sm-6 col-xs-12" id="botonguardar">
    <div class="form-group">
    ...
    <script>
        ...
        function agregar() {
            ...
            cont++;
                ...
                alert("Error:Verifique los datos del articulo");
            }
        }
    function limpiar() {
        $('#cantidad').val("");
